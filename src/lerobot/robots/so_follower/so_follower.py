...
class SOFollower(Robot):
    ...
    def get_observation(self) -> RobotObservation:
        # Read arm position.
        # num_retry: a single transient bus glitch (electrical noise from the servos under
        # load, a USB hiccup) otherwise raises straight out of the control loop and kills
        # the run. The read is idempotent, so retrying costs nothing when the bus is clean.
